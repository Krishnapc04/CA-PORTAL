...
<SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 229, 255, 0.2)">
  ...
  <ol >
    <li><p>Act as a bridge between COMPOSIT, IIT Kharagpur, and your college.</p></li>
    <li><p>Encourage and ensure active participation of students from your college in various events, workshops, Guest Lectures, and competitions.</p></li>
...
const Responsibilities = () => {
  ...
  return (
    <div  className="work mt-52">
      <h1 className="text-4xl mb-1 font-bold flex justify-center gap-2 text-yellow-300"> Your Responsibilities</h1>
